...
相关推荐：
  ...
  * [经典动态规划：高楼扔鸡蛋（进阶）](https://labuladong.github.io/algo/)
...
那么该如何在 LeetCode 刷题呢？之前的文章[算法学习之路](https://labuladong.github.io/algo/)写过一些，什么按标签刷，坚持下去云云。现在距那篇文章已经过去将近一年了，我不说那些不痛不痒的话，直接说具体的建议：
...
[动态规划详解](https://labuladong.github.io/algo/)说过凑零钱问题，暴力解法就是遍历一棵 N 叉树：
...
再看看回溯算法，前文[回溯算法详解](https://labuladong.github.io/algo/)干脆直接说了，回溯算法就是个 N 叉树的前后序遍历问题，没有例外。
...
这种思维是很重要的，[动态规划详解](https://labuladong.github.io/algo/)中总结的找状态转移方程的几步流程，有时候按照流程写出解法，说实话我自己都不知道为啥是对的，反正它就是对了。。。
