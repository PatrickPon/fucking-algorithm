...
相关推荐：
  * [讲两道常考的阶乘算法题](https://labuladong.github.io/algo/)
...
信封嵌套问题就需要先按特定的规则排序，之后就转换为一个 [最长递增子序列问题](https://labuladong.github.io/algo/)，可以用前文 [二分查找详解](https://labuladong.github.io/algo/) 的技巧来解决了。
