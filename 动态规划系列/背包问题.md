...
解决这个问题没有什么排序之类巧妙的方法，只能穷举所有可能，根据我们 [动态规划详解](https://labuladong.github.io/algo/) 中的套路，直接走流程就行了。
...
PS：此框架出自历史文章 [团灭 LeetCode 股票问题](https://labuladong.github.io/algo/)。
...
* [背包问题变体之子集分割](https://labuladong.github.io/algo/)
* [完全背包问题之零钱兑换](https://labuladong.github.io/algo/)
